...
# Install fleetctl
RUN wget https://github.com/coreos/fleet/releases/download/v0.8.3/fleet-v0.8.3-linux-amd64.tar.gz
RUN tar -xzf fleet-v0.8.3-linux-amd64.tar.gz; cd fleet-v0.8.3-linux-amd64; mv fleetctl /usr/bin
